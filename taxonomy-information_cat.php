...
?>
    ...
    <div class="contentWrapper informationPage">
        <main>
            <div class="underHead">
                <h1 class="underHead__text">INFORMATION<span><?php echo $current_term_name; ?>一覧</span></h1>
            </div>
            <nav class="pnkz">
                <ul class="pnkz__list">
                        ...
                        <?php
                            ...
                            foreach ( $information_cat as $term ) {
                                if($current_term_slug == $term->slug){
                                    echo '<li class="select"><a href="'.get_term_link($term->slug,'information_cat').'">'.$term->name.'</li>';
                                } else {
